 ...
 * @author aburgos
 */
@ManagedBean(name = "rpt_personal_ocupadoAction")
@SessionScoped
public class Rpt_personal_ocupadoAction extends AbstactListAction<Ordenserviciocliente> {
    /*************************************ArrayList***************************************/
    ...
    public Rpt_personal_ocupadoAction() {
        /*********************************ENTITY*******************************************/
    ...
    public void buscarTodo() {
        try {
            ...
            Logger.getLogger(Rpt_personal_ocupadoAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void buscar_filtrofecha() {
        try {
            ...
            f_ini = f_ini.replace("-", "");
            f_fin = f_fin.replace("-", "");
            setRpt_result(getOrdenservicioclienteDao().getConsultaRepote_personal_ocupado(user.getIDEMPRESA()));
