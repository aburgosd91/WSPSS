 ...
 * @author aburgos
 */
@ManagedBean(name = "cntClieprovPersonalSupervisorAction")
@ViewScoped
public class CntClieprovPersonalSupervisorAction {
    ...
    public void init() {
        ...
        try {
            ...
            setDatos(rd.listarPorEmpresaPersonal_Supervisor_Web(u.getIDEMPRESA()));
        } catch (Exception ex) {
            Logger.getLogger(CntClieprovPersonalSupervisorAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
