...
//    static final String cadenaEncriptado = "|°!#$%&/()=?¡'¿<}~ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑª¿®¦ÁÂÀ©¦ãÃ.";
    ...
    static Map<Character,Character> rowDE;
    static Map<Character,Character> rowED;
    ...
    public static String Desencriptar(String cadena){
        ...
        for(int i = 0;i<charPassword.length;i++)
        {
            desencriptado = desencriptado + ((rowED.get(charPassword[i]) == null)? charPassword[i] : rowED.get(charPassword[i]));
        }
...
//                        System.out.println(c1 + " " + c2 + " ------> " + texto);
    ...
    public static void main(String[] args) {
        ...
        String passencryp="LSHBDdUXj6z/KME18NpPrQ==";
        System.err.println("Clave Des:"+Desencriptar(passencryp));
        String user = "Pa$$word2015";
        System.err.println("Clave Encr :"+Encriptar(user));
    }
}
