 ...
 * @author aburgos
 */
@ManagedBean(name = "rpt_servicios_cruzadosAction")
@SessionScoped
public class Rpt_servicios_cruzadosAction extends AbstactListAction<Ordenserviciocliente> {
    /*************************************ArrayList***************************************/
    ...
    public Rpt_servicios_cruzadosAction() {
        try {
            /*********************************ENTITY*******************************************/
        ...
        actualiza_ventana("wMnt_Rpt_servicios_cruzados");
    }
...
//                newObj.setItem(listReporte_facturacion.size()+1);
    ...
    public void buscar_filtrofecha() {
        try {
            ...
            f_ini = f_ini.replace("-", "");
            f_fin = f_fin.replace("-", "");
            listReporte_facturacionTotal = getOrdenservicioclienteDao().listar_servicios_cruzados_detalladoFiltroFecha(user.getIDEMPRESA(),f_ini,f_fin,idtiposervicio);
...
//            findetalle();
    ...
    public String buscarFiltro(int tipo){
        ...
        if(tipo == 2)
            lista_accion_filtro("wLst_Rpt_servicios_cruzados");
        return "";
    }
