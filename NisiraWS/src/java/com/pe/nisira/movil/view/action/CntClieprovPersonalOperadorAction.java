 ...
 * @author aburgos
 */
@ManagedBean(name = "cntClieprovPersonalOperadorAction")
@ViewScoped
public class CntClieprovPersonalOperadorAction {
    ...
    public void init() {
        ...
        try {
            ...
            setDatos(rd.listarPorEmpresaPersonal_Operario_Web(u.getIDEMPRESA()));
        } catch (Exception ex) {
            Logger.getLogger(CntClieprovPersonalOperadorAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
