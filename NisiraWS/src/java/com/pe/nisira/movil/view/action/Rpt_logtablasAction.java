...
import com.nisira.core.dao.LogTablasDao;
 ...
 * @author aburgos
 */
@ManagedBean(name = "rpt_logtablasAction")
@SessionScoped
public class Rpt_logtablasAction extends AbstactListAction<LogTablas> {
    /*************************************ArrayList***************************************/
    ...
    /*************************************DAO***************************************/
    private LogTablasDao logTablasDao;
    ...
    public Rpt_logtablasAction() {
        try{
            ...
            actualiza_ventana("wMnt_Rpt_logtablas");
    ...
    public void buscarTodo() {
        try {
            ...
            Logger.getLogger(Rpt_logtablasAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void buscar_filtrofecha() {
        try {
            ...
            setListaDatos(logTablasDao.lstLogTablas(user.getIDEMPRESA(), lstusuarioLocal, lstconfig_ventana_filtro_webLocal,
    ...
    public String buscarFiltro(int tipo){
        ...
        RequestContext.getCurrentInstance().update("datos:tbl");
//        if(tipo == 2)
//            lista_accion_filtro("wLst_Rpt_logtablas");
        return "";
    }
