 ...
 * @author aburgos
 */
@ManagedBean(name = "Cabcalculopagar_modAction")
@SessionScoped
public class Cabcalculopagar_modAction extends AbstactListAction<Cabcalculopagar> {
    /*************************************ArrayList***************************************/
    private List<Cabcalculopagar_planilla> lstCabcalculopagar_planilla;
    ...
    private Cabcalculopagar_planilla selectCabcalculopagar_planilla;
    ...
    public Cabcalculopagar_modAction() {
        try {
            /*********************************ENTITY*******************************************/
            ...
            lstCabcalculopagar_planilla = new  ArrayList<>();
            /*********************************DAO**********************************************/
            ...
            actualiza_ventana("wMnt_Cabcalculopagar_mod");
        }catch (Exception ex) {
            System.out.println(ex);
            Logger.getLogger(Cabcalculopagar_modAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        try {
            if (esVistaValida()) {
                ...
                if(getDatoEdicion().getIdcabcalculopagar()==null){
                    mensaje=getCabcalculopagarDao().grabar_mod(1, getDatoEdicion(), 
                            getListDetcalculopagarTotal(),user.getIDUSUARIO(),listDocreferencia);
                    if(mensaje!=null)
                        if(mensaje.trim().length()==15)
                            getDatoEdicion().setIdcabcalculopagar(mensaje.trim());
                }
                else
                    mensaje=getCabcalculopagarDao().grabar_mod(2, getDatoEdicion(),getListDetcalculopagarTotal(),
                            user.getIDUSUARIO(),listDocreferencia);
        ...
        try {
            if (esVistaValida()) {
                ...
                if(getDatoEdicion().getIdcabcalculopagar()==null){
                    ...
                    mensaje=getCabcalculopagarDao().grabar_mod(2, getDatoEdicion(),getListDetcalculopagarTotal(),user.getIDUSUARIO(),listDocreferencia);
...
//                RequestContext.getCurrentInstance().update("datos");
    ...
    public void onRowCancelDocreferencia(RowEditEvent event) {
        try {
            ...
            /*ELIMINAR REFERENCIAS - CABCALCULOPAGAR_PLANILL - */
            if(WebUtil.isnull(getDatoEdicion().getIdcabcalculopagar(), "").equals("")){
                listDetcalculopagarTotal = new ArrayList<>();
                listDetcalculopagar = new ArrayList<>();
            }
            else{
                listDetcalculopagarTotal.removeIf(det -> det.getIdcabcalculopagar().equals(obj.getIdorigen()));
                listDetcalculopagar = new ArrayList<>();
    ...
    public void findetalle() throws Exception {
        try{
            if(getLadd()==1){/*NUEVO*/
                ...
                listDetcalculopagar = new ArrayList<>();
                listDocreferencia = new ArrayList<>();
                listDocreferencia = docreferenciaDao.getDoreferencia_tabla_origenWeb(user.getIDEMPRESA(), getDatoEdicion().getIdcabcalculopagar(), "CABCALCULOPAGAR_PLANILLA");
    ...
    public void verCntDocReferencia() {
        try {
            lstCabcalculopagar_planilla =  cabcalculopagar_planillaDao.listarPorEmpresaWebFiltroAprobado(user.getIDEMPRESA());
            if(lstCabcalculopagar_planilla.isEmpty()){
                setMensaje("No existen documentos Aprobados");
                WebUtil.fatal(mensaje);
                RequestContext.getCurrentInstance().update("datos:growl");
            }else{
                RequestContext.getCurrentInstance().update("datos:dlgnew_cabcalculo_planilla");
                RequestContext.getCurrentInstance().execute("PF('dlgnew_cabcalculo_planilla').show()");
            }
        } catch (Exception ex) {
            Logger.getLogger(OrdenservicioclienteAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void addDocreferencia(){
        try {
            ...
            obj.setIdorigen(getDatoEdicion().getIdcabcalculopagar());
            obj.setTabla("CABCALCULOPAGAR_PLANILLA");
            obj.setIdreferencia(selectCabcalculopagar_planilla.getIdcabcalculopagar_planilla());
            obj.setIddocumento(selectCabcalculopagar_planilla.getIddocumento());
            obj.setSerie(selectCabcalculopagar_planilla.getSerie());
            obj.setNumero(selectCabcalculopagar_planilla.getNumero());
            obj.setFecha(selectCabcalculopagar_planilla.getFecha());
            /*****************************************/
            getListDocreferencia().add(obj);
            RequestContext.getCurrentInstance().update("datos:tabledocreferencia");
            RequestContext.getCurrentInstance().execute("PF('dlgnew_cabcalculo_planilla').hide()");
            addDetalle();
        } catch (Exception ex) {
            Logger.getLogger(OrdenservicioclienteAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void addDetalle(){
        try {
            /****** INICIALIZAR *******/
            listDetcalculopagarTotal = new ArrayList<>();
            listDetcalculopagarTotal = detcalculopagarDao.listar_detallado_docreferencia(user.getIDEMPRESA(), selectCabcalculopagar_planilla.getIdcabcalculopagar_planilla());
            if(listDetcalculopagarTotal.isEmpty()){
                    setMensaje("No se muestran registros");
                    WebUtil.info(getMensaje());
                    //setLvalidate(true);
...
//            cargarCuentasDetraccionDocumentos();
        ...
        if(tipo == 2)
            lista_accion_filtro("wLst_Cabcalculopagar_mod");
        return "";
    }
...
//Filas           
    ...
    /**
     * @return the lstCabcalculopagar_planilla
     */
    public List<Cabcalculopagar_planilla> getLstCabcalculopagar_planilla() {
        return lstCabcalculopagar_planilla;
    }

    /**
     * @param lstCabcalculopagar_planilla the lstCabcalculopagar_planilla to set
     */
    public void setLstCabcalculopagar_planilla(List<Cabcalculopagar_planilla> lstCabcalculopagar_planilla) {
        this.lstCabcalculopagar_planilla = lstCabcalculopagar_planilla;
    }

    /**
     * @return the cabcalculopagar_planillaDao
     */
    public Cabcalculopagar_planillaDao getCabcalculopagar_planillaDao() {
     ...
     */
    public void setCabcalculopagar_planillaDao(Cabcalculopagar_planillaDao cabcalculopagar_planillaDao) {
        this.cabcalculopagar_planillaDao = cabcalculopagar_planillaDao;
    }

    /**
     * @return the selectCabcalculopagar_planilla
     */
    public Cabcalculopagar_planilla getSelectCabcalculopagar_planilla() {
        return selectCabcalculopagar_planilla;
    }

    /**
     * @param selectCabcalculopagar_planilla the selectCabcalculopagar_planilla to set
     */
    public void setSelectCabcalculopagar_planilla(Cabcalculopagar_planilla selectCabcalculopagar_planilla) {
        this.selectCabcalculopagar_planilla = selectCabcalculopagar_planilla;
    }
