 ...
 * @author aburgos
 */
@ManagedBean(name = "cntClieprovPersonalSAction")
@ViewScoped
public class CntClieprovPersonalSAction {
    ...
    public void init() {
        ...
        try {
            ...
            Logger.getLogger(CntClieprovPersonalSAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
