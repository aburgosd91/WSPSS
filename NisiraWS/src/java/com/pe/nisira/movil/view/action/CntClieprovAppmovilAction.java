 ...
 * @author aburgos
 */
@ManagedBean(name = "cntClieprovAppmovilAction")
@ViewScoped
public class CntClieprovAppmovilAction {
    ...
    public void init() {
        ...
        try {
            ...
            setDatos(rd.listarPorEmpresaPersonalAppmovilWeb(u.getIDEMPRESA()));
        } catch (Exception ex) {
            Logger.getLogger(CntClieprovAppmovilAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
